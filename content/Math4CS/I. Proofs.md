...
:::info
An **execution** of the state machine is a (possibly infinite) sequence of states with the property that it begins with the start state, and if q and r are consecutive states in the sequence, then q -> r.
...
:::info
Phần này nói về việc sử dụng WOP và hàm tiềm năng để chứng minh một chương trình sẽ đạt trạng thái dừng. Thì trong toán học tổ hợp cũng có một dạng bài toán yêu cầu chứng minh tồn tại trạng thái dừng, gọi là phương pháp đơn biến trong đó sẽ tập trung tìm một hàm, làm sao khi áp dụng hàm đó thì đến một lúc nào đó nó sẽ đạt về 0 chẳng hạn (không nhớ lắm =))) nhưng cơ bản idea nó cũng giống như này.
:::

:::info
Về việc ứng dụng Invariant Principle thì chắc cũng quen thuộc rồi, nó là phương pháp bất biến, dùng để tìm ra quy luật không đổi trong mọi trạng thái. Dễ thấy nhất là ứng dụng trong các bài toán tổ hợp chứng minh rằng không tồn tại một trạng thái T nào đó. Ta chỉ cần chứng minh không thỏa một bất biến trong toàn bộ execution hoặc giữa các state transition để giải bài toán dạng này.
:::

## 6. Recursive Data Types (Kiểu dữ liệu đệ quy)

:::info
Một kiểu dữ liệu được gọi là đệ quy khi nó được xác định dựa trên chính nó. Phần tử ở sau định nghĩa dựa trên phần tử ở trước.
Khái niệm này đã làm quen ở dãy số rồi.
:::
...
Nếu một phần tử có thể được tạo ra theo hai cách, và bạn định nghĩa một hàm $f$ dựa trên cấu trúc đó, thì hàm $f$ có thể trả về hai giá trị khác nhau cho cùng một đầu vào. Vậy $f$ vi phạm định nghĩa của một hàm số.
:::
...
:::info
Giả sử có một tập $A$. $A$ được gọi là countably infinite khi có một song ánh từ $N$ đến $A$.
:::

:::info
Tổng quát, giả sử có tập $A$. $A$ được gọi là countable (kể cả khi $A$ finite hay infinite) khi có một toàn ánh từ $N$ đến $A$.
:::
