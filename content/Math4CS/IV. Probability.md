...
# Section 6: Probability & Distribution
...
Đặc trưng của biến ngẫu nhiên rời rạc là *PMF*, còn liên tục là *PDF*. Đặc điểm chung của 2 loại biến ngẫu nhiên này là đều có hàm phân bố tích lũy **CDF** (Cumulative distribution function).
